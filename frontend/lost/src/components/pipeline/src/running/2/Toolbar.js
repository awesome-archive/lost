        ...
        {this.props.data && (
          <>
            ...
            <Button
              ...
              onClick={
                this.props.data.progress === "PAUSED" ? this.play : this.pause
              }
              color="secondary"
            >
            ...
            <ToolbarTooltip
              ...
              text={this.props.data.progress === "PAUSED" ? "Play" : "Pause"}
            />
            <ToolbarTooltip
...
export default connect(
  null,
  { pausePipeline, playPipeline, deletePipeline, downloadLogfile, postPipeline }
)(Toolbar);
